...
const Dashboard = () => {
  ...
  // 3. Reset page if it's now out of bounds - Moved down to ensure totalPages is initialized
  useEffect(() => {
    ...
    <div className="max-w-7xl mx-auto w-full space-y-8 animate-in fade-in duration-1000">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        >
          ...
          <p className="text-[#86868B] dark:text-[#A1A1AA] mt-1 font-medium">Keep pushing forward.</p>
        </motion.div>
        ...
        <div className="relative h-[348px] overflow-hidden">
          {isLoading ? (
            ...
            <div className={`${cardStyle} py-20 flex flex-col items-center justify-center text-center p-8 border-2 border-dashed border-apple-blue/10`}>
              ...
              <p className="text-[#86868B] dark:text-[#A1A1AA] text-lg max-w-[320px] font-medium leading-snug">You've mastered today's goals. Enjoy the clarity.</p>
            </div>
          )}
        </div>
